...
# Define the function
get_item_ids <- function(url, items = character(), conditional = TRUE, depth = 0, max_depth = 7) {
  if (depth > max_depth) {
...
for (item_id in ids_list_json) {
  ...
  # Enforce throttling: 1 request per 4 seconds (staying under the LOC's 20 per minute limit)
  Sys.sleep(4)
}
